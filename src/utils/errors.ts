 ...
 *
 * Custom error classes and error handling helpers for the Notion API.
 */
 ...
 */
export class AuthenticationError extends NotionApiError {
 ...
 * Not found error
 */
export class NotFoundError extends NotionApiError {
 ...
 * Validation error
 */
export class ValidationError extends NotionApiError {
